...
export const idleControls = (): ControlInput => ({ main: 0, reverse: 0, strafe: 0, turn: 0 });
...
export const cloneControls = (controls: ControlInput): ControlInput => ({ ...controls });

export const cloneSimulationState = (state: SimulationState, controls: ControlInput = idleControls()): SimulationState => ({
