...
export const restoreRuntimeFromScenarioCheckpoint = (runtime: AppRuntimeState) => {
  ...
  runtime.state = cloneSimulationState(checkpoint.world, checkpoint.world.controls);
