import { createRuntimeScenarioSession, type ScenarioSessionValue } from "./scenarioSession";
...
export const registerMenuBackgroundScenario = (): RuntimeScenarioDefinition<MenuBackgroundScenarioState> => ({
  id: "menu-background",
  createScenario: () => {
