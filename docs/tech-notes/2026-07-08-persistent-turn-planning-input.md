...
- Pending turn planning now uses amber in-world presentation, including an amber dashed target line, amber turn-slice fill, and a target-point reticle so it reads differently from a committed cyan turn.
